	...
	var default_options  = {
		i18n: {
			...
			is: { // Icelandic
				...
				dayOfWeekShort: [
					"Sun", "Mán", "?ri?", "Mi?", "Fim", "F?s", "Lau"
				],
				dayOfWeek: ["Sunnudagur", "Mánudagur", "?ri?judagur", "Mi?vikudagur", "Fimmtudagur", "F?studagur", "Laugardagur"]
			},
			bg: { // Bulgarian
				months: [
			...
			cs: { // ?e?tina
				months: [
					"Leden", "?nor", "B?ezen", "Duben", "Květen", "?erven", "?ervenec", "Srpen", "Zá?í", "?íjen", "Listopad", "Prosinec"
				],
				dayOfWeekShort: [
					"Ne", "Po", "?t", "St", "?t", "Pá", "So"
				]
